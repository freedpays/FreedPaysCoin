...
unsigned int nStakeMinAge = 20 * 60; // 30 min
...
const string strMessageMagic = "FreedPays Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees, int nHeight)
{
    ...
    if (pindexBest->nMoneySupply < MAX_MONEY){
        if(pindexBest->nHeight == 0) //premine 1.5M 3% MAX_MONEY*0.03
        {
...
#ifdef ENABLE_WALLET
// FreedPays: attempt to generate suitable proof-of-stake
...
{
    RenameThread("FreedPays-loadblk");
